...
export class UserService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public userGetIdGet(id: string, observe?: 'body', reportProgress?: boolean): Observable<UserResponse>;
    public userGetIdGet(id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<UserResponse>>;
    public userGetIdGet(id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<UserResponse>>;
    public userGetIdGet(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling userGetIdGet.');
        }
        ...
        return this.httpClient.request<UserResponse>('get', `${this.basePath}/User/get/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers,
                observe,

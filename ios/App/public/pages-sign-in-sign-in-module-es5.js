...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-sign-in-sign-in-module"], {
  ...
  function srcAppPagesSignInSignInPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SignInPage_ng_container_7_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SignInPage_ng_container_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SignInPage_div_12_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 16);
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 6:
                    _context.next = 8;
                    return this.accountService.login(loginModel.userName, loginModel.password).then(function (value) {
                      if (value === null) {
                        _this.invalidLogin = true;
                        loading.dismiss();
                      }

                      var navigationExtras = {// replaceUrl: false,
                        // state: {
                        //   userId: value.id
                        // }
                      };
    ...
    SignInPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function SignInPage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function SignInPage_Template_form_ngSubmit_3_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SignInPage_Template_ion_icon_click_10_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SignInPage_Template_ion_button_click_17_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SignInPage, [{
        ...
        return [{
          ...
          type: src_app_backend_clients__WEBPACK_IMPORTED_MODULE_3__["AccountsService"]
        }];
      }, null);
    })();
    /***/

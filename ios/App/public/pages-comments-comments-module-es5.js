...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-comments-comments-module"], {
  ...
  function srcAppPagesCommentsCommentsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CommentsPage_h1_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CommentsPage_ion_item_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var CommentsPage = /*#__PURE__*/function () {
      function CommentsPage(storage, modalController, router, zone, route, postSvc, accountService) {
        var _this = this;
    ...
    CommentsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CommentsPage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CommentsPage_Template_ion_input_ngModelChange_16_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CommentsPage_Template_button_click_17_listener() {

...
/* harmony import */ var _backend_clients_api_user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../backend/clients/api/user.service */ "./src/app/backend/clients/api/user.service.ts");
...
/* harmony import */ var _objects_location_json_json_countries_json__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../objects/location-json/json/countries.json */ "./src/app/objects/location-json/json/countries.json");
var _objects_location_json_json_countries_json__WEBPACK_IMPORTED_MODULE_11___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../objects/location-json/json/countries.json */ "./src/app/objects/location-json/json/countries.json", 1);
...
class UserProfilePage {
    ...
    async ionViewDidEnter() {
        ...
        this.zone.run(() => {
            this.getUser(loading).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["take"])(1)).subscribe(() => {
                // loading.dismiss();
            });
        });
    }
    getUser(loading) {
        return this.userService.userIdGet(this.userId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(user => {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserProfilePage, [{
    ...
    }], function () { return [{ type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["LoadingController"] }, { type: _backend_clients_api_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"] }, { type: _backend_clients_api_accounts_service__WEBPACK_IMPORTED_MODULE_6__["AccountsService"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }, { type: _services_modal_service__WEBPACK_IMPORTED_MODULE_9__["ModalService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: _ionic_storage__WEBPACK_IMPORTED_MODULE_10__["Storage"] }]; }, null); })();

...
/* harmony import */ var _user_timeline_user_timeline_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../user-timeline/user-timeline.page */ "./src/app/pages/user-timeline/user-timeline.page.ts");
/* harmony import */ var _backend_clients_api_user_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../backend/clients/api/user.service */ "./src/app/backend/clients/api/user.service.ts");
/* harmony import */ var _backend_clients_api_accounts_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../backend/clients/api/accounts.service */ "./src/app/backend/clients/api/accounts.service.ts");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var _services_modal_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../services/modal.service */ "./src/app/services/modal.service.ts");
...
/* harmony import */ var _objects_location_json_json_countries_json__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../objects/location-json/json/countries.json */ "./src/app/objects/location-json/json/countries.json");
var _objects_location_json_json_countries_json__WEBPACK_IMPORTED_MODULE_12___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../objects/location-json/json/countries.json */ "./src/app/objects/location-json/json/countries.json", 1);
...
function UserProfilePage_ion_button_42_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserProfilePage_ion_button_42_Template_ion_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.presentUserSettings(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "ion-icon", 38);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function UserProfilePage_ion_list_82_ion_item_1_Template(rf, ctx) { if (rf & 1) {
    const _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ion-item", 40);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserProfilePage_ion_list_82_ion_item_1_Template_ion_item_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const data_r5 = ctx.$implicit; const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r6.dataas(data_r5); });
...
function UserProfilePage_ion_list_82_Template(rf, ctx) { if (rf & 1) {
...
class UserProfilePage {
    ...
    modalController, loadingController, userService, accountService, zone, route, myservice, router, storage) {
    ...
    async ionViewDidEnter() {
        ...
        this.zone.run(() => {
            this.getUser(loading).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["take"])(1)).subscribe(() => {
                // loading.dismiss();
            });
        });
    }
    getUser(loading) {
        return this.userService.userIdGet(this.userId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(user => {
...
UserProfilePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UserProfilePage, selectors: [["user-profile"]], decls: 87, vars: 16, consts: [[1, "ion-no-border", 2, "background-color", "#128C7E"], ["color", "#128C7E", 1, "ion-no-border"], [1, "header-grid"], [1, "ion-align-items-baseline"], [1, "ion-justify-content-start"], ["defaultHref", "/tab1", 2, "color", "white"], [1, "ion-justify-self-center"], [2, "text-align", "center", "font-size", "15px", "color", "#FFF", "margin", "0", "text-transform", "capitalize", "font-weight", "bold"], [1, "ion-justify-content-end"], [1, "ion-justify-content-end", 3, "click"], ["src", "../../../assets/UI/search-outline.svg", 1, "img-center"], [3, "scrollY"], [1, "three-col-grid"], [3, "src"], [1, "header-text"], ["size", ".5"], ["src", "../../../assets/UI/cake_icon.svg", 1, "places"], ["color", "medium"], ["src", "../../../assets/UI/location_pin_icon.svg", 1, "places"], ["fill", "clear", "class", "edit-button", 3, "click", 4, "ngIf"], [1, "profile-info-row"], [1, "ion-align-self-end"], [1, "profile-info"], [1, "ion-align-self-end", "visited-col"], [1, "ion-align-self-end", "to-visit-col"], [2, "margin-bottom", "0"], ["size", ".5", 1, "ion-align-self-center"], ["src", "../../../assets/UI/globe_icon.svg"], ["size", "1.7", 1, "ion-align-self-center", "ion-justify-content-start"], ["size", "1", 3, "percent"], [1, "map-search-container"], ["spellcheck", "true", 3, "ngModel", "focusout", "search", "focusin", "ngModelChange"], [4, "ngIf"], ["id", "user-map", "onload", "onLoad()", 1, "chartdiv"], ["vertical", "bottom", 1, "map-filter-fab"], ["fill", "clear", 1, "map-filter", 3, "click"], ["src", "../../../assets/UI/floating_map_button.svg"], ["fill", "clear", 1, "edit-button", 3, "click"], ["name", "settings-outline"], [3, "click", 4, "ngFor", "ngForOf"], [3, "click"]], template: function UserProfilePage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("focusout", function UserProfilePage_Template_ion_searchbar_focusout_81_listener() { return ctx.show(true); })("search", function UserProfilePage_Template_ion_searchbar_search_81_listener() { return ctx.searchvalue(); })("focusin", function UserProfilePage_Template_ion_searchbar_focusin_81_listener() { return ctx.show(false); })("ngModelChange", function UserProfilePage_Template_ion_searchbar_ngModelChange_81_listener($event) { return ctx.filterTerm = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserProfilePage_Template_ion_button_click_85_listener() { return ctx.presentUserTimeline(); });
    ...
    } }, directives: [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonHeader"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonToolbar"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonGrid"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonRow"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonCol"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonButtons"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonBackButton"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonBackButtonDelegate"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonButton"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonContent"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonCard"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonCardContent"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonAvatar"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonText"], _angular_common__WEBPACK_IMPORTED_MODULE_13__["NgIf"], ng_circle_progress__WEBPACK_IMPORTED_MODULE_14__["CircleProgressComponent"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonSearchbar"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["TextValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_15__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_15__["NgModel"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonFab"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonIcon"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonList"], _angular_common__WEBPACK_IMPORTED_MODULE_13__["NgForOf"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonItem"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonLabel"]], pipes: [ng2_search_filter__WEBPACK_IMPORTED_MODULE_16__["Ng2SearchPipe"]], styles: ["ion-content[_ngcontent-%COMP%] {\n  --background: linear-gradient(to bottom, #128C7E 30%, #ffffff 30%) ;\n}\n\n.header-grid[_ngcontent-%COMP%] {\n  --ion-grid-columns: 3;\n  --ion-grid-column-padding:.5px;\n  --ion-grid-padding:1px;\n}\n\n.header-text[_ngcontent-%COMP%]   ion-text[_ngcontent-%COMP%] {\n  font-size: 13px;\n  text-transform: capitalize;\n}\n\n.profile-info[_ngcontent-%COMP%]   ion-text[_ngcontent-%COMP%] {\n  font-size: 11px;\n  text-transform: capitalize;\n}\n\n.profile-info-row[_ngcontent-%COMP%]   ion-row[_ngcontent-%COMP%] {\n  justify-content: space-evenly;\n  margin-bottom: 0;\n}\n\n.three-col-grid[_ngcontent-%COMP%] {\n  --ion-grid-padding:5px;\n  --ion-grid-columns: 3;\n  --ion-grid-column-padding:.5px;\n}\n\n.three-col-grid[_ngcontent-%COMP%]   ion-row[_ngcontent-%COMP%] {\n  margin-bottom: 3%;\n  font-size: 13px;\n}\n\nh3[_ngcontent-%COMP%] {\n  font-size: 12px;\n}\n\nh6[_ngcontent-%COMP%] {\n  font-size: 3vw;\n  color: black;\n}\n\n.to-visit-col[_ngcontent-%COMP%]   ion-row[_ngcontent-%COMP%]   h6[_ngcontent-%COMP%] {\n  color: #F05E23;\n}\n\n.to-visit-col[_ngcontent-%COMP%]   ion-row[_ngcontent-%COMP%]   ion-text[_ngcontent-%COMP%] {\n  color: #F05E23;\n}\n\n.visited-col[_ngcontent-%COMP%]   ion-row[_ngcontent-%COMP%]   h6[_ngcontent-%COMP%] {\n  color: #128C7E;\n}\n\n.visited-col[_ngcontent-%COMP%]   ion-row[_ngcontent-%COMP%]   ion-text[_ngcontent-%COMP%] {\n  color: #128C7E;\n}\n\n.edit-button[_ngcontent-%COMP%] {\n  --background: transparent;\n  --color: black;\n}\n\nion-avatar[_ngcontent-%COMP%] {\n  width: 110% !important;\n  height: 110% !important;\n  max-width: 80px !important;\n  max-height: 80px !important;\n}\n\n.map-search-container[_ngcontent-%COMP%] {\n  padding-left: 10%;\n  padding-right: 10%;\n  margin-top: 5px;\n}\n\n.chartdiv[_ngcontent-%COMP%] {\n  width: 100%;\n}\n\nion-card[_ngcontent-%COMP%] {\n  margin-top: 0;\n  margin-bottom: 0;\n}\n\nion-card-content[_ngcontent-%COMP%] {\n  padding-top: 10px;\n  padding-bottom: 0;\n}\n\n.map-filter[_ngcontent-%COMP%] {\n  justify-content: center;\n  align-self: center;\n}\n\n.map-filter-fab[_ngcontent-%COMP%] {\n  justify-content: center;\n  align-self: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserProfilePage, [{
    ...
    }], function () { return [{ type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["LoadingController"] }, { type: _backend_clients_api_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"] }, { type: _backend_clients_api_accounts_service__WEBPACK_IMPORTED_MODULE_7__["AccountsService"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }, { type: _services_modal_service__WEBPACK_IMPORTED_MODULE_10__["ModalService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: _ionic_storage__WEBPACK_IMPORTED_MODULE_11__["Storage"] }]; }, null); })();

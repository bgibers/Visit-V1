...
class AccountsService {
    ...
    async loginApple(appleResponse) {
        const provider = new firebase_app__WEBPACK_IMPORTED_MODULE_6__["default"].auth.OAuthProvider('apple.com');
        ...
        const userCredential = await firebase_app__WEBPACK_IMPORTED_MODULE_6__["default"].auth().signInWithCredential(credential);
    }
